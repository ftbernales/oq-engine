...
class StewartEtAl2016VH(GMPE):
    ...
    **Reference:**
    ...
    def _get_stddevs(self, C, sites, rup, dists, imt, stddev_types):
        ...
        tau_v = self.VGMPE._get_stddevs(C_V, rup, sites, inter_std)
        tau_h = self.HGMPE._get_stddevs(C_H, rup, dists, sites, inter_std)
        phi_v = self.VGMPE._get_stddevs(C_V, rup, sites, intra_std)
        phi_h = self.HGMPE._get_stddevs(C_H, rup, dists, sites, intra_std)
    ...
    def _get_tau_vh(self, C, mag, stddev_v, stddev_h):
        ...
        Equation 13c.
        """
        return BC15b._get_tau_vh(self, C, mag, stddev_v, stddev_h)
    ...
    def _get_phi_vh(self, C, mag, stddev_v, stddev_h):
        ...
        Equation 13b.
        """
        return BC15b._get_phi_vh(self, C, mag, stddev_v, stddev_h)
